...
def load_config(config_path: os.PathLike):
    ...
    try:
        ...
        for section in cfg.sections():
            os_dict[section] = OS(name=section, lib_update=cfg.get(section, 'lib_update'), distro_check=cfg.get(section, 'distro_check'), distro_check_neg=cfg.get(section, 'distro_check_neg'), distro_check_pos=cfg.get(section, 'distro_check_pos'))
